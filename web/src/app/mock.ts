import type { AuditEntry, GraphEdge, GraphNode, Risk, Rules, WorkspaceState } from '../types';

/**
 * The seeded demo workspace: a regulatory team pushing a Moderna submission.
 *
...
export const PEOPLE: GraphNode[] = [
  ...
  P('u:amara', 'Amara Okafor', 0.12, 0.35, 'Programme manager'),
  P('u:baton', 'Baton', 0, 0.5, 'AI coworker'),
];

const WORK: GraphNode[] = [
  W('p:moderna', 'project', 'Moderna submission', 0.84, 1, 'Module 3 due 14 Sep'),
  ...
  W('th:moderna-ask', 'thread', 'Module 3 sign-off', 0.93, 0.7, 'Mail · 6 days, no reply'),
...
export const EDGES: GraphEdge[] = [
  ...
  { source: 'u:nicolas', target: 'th:moderna-ask', kind: 'asks', open: true },
  { source: 'th:moderna-ask', target: 'u:sally', kind: 'asks', open: true },
  { source: 'th:moderna-ask', target: 'p:moderna', kind: 'mentions' },
  { source: 'th:moderna-ask', target: 'd:module3', kind: 'blocks', open: true },
  ...
  { source: 't:method-val', target: 'p:moderna', kind: 'mentions' },
  { source: 't:impurity', target: 'p:moderna', kind: 'mentions' },

  // the rest of the team
  { source: 'u:tomas', target: 't:sap-sync', kind: 'assigned' },
  { source: 'u:amara', target: 't:cover-letter', kind: 'assigned' },
  { source: 't:cover-letter', target: 'p:moderna', kind: 'mentions' },
  { source: 't:sap-sync', target: 'p:moderna', kind: 'mentions' },
  { source: 'u:nicolas', target: 'p:moderna', kind: 'participates' },
  { source: 'u:sally', target: 'p:moderna', kind: 'participates' },
  { source: 'u:amara', target: 'th:qa-window', kind: 'participates' },
  { source: 'u:tomas', target: 'th:qa-window', kind: 'participates' },
  { source: 'd:module3', target: 'p:moderna', kind: 'mentions' },
  ...
  { source: 'u:baton', target: 'p:moderna', kind: 'participates' },
...
export const RISKS: Risk[] = [
  {
    ...
    nodes: ['u:nicolas', 'u:sally', 'th:moderna-ask', 'd:module3'],
    project: 'Moderna submission',
    ageDays: 6,
    dueInDays: 2,
...
export const INCOMING_RISK: Risk = {
  ...
  nodes: ['u:priya', 'th:moderna-ask', 'd:module3', 'p:moderna'],
  project: 'Moderna submission',
  ageDays: 0,
  dueInDays: 2,
  unowned: true,
